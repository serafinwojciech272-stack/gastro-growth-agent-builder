...
export default function App() { return <Routes><Route path="/" element={<PublicSite/>}/><Route path="/login" element={<AuthPage/>}/><Route path="/signup" element={<AuthPage/>}/><Route path="/app/onboarding" element={<OnboardingPage/>}/><Route path="/app/dashboard" element={<DashboardPage/>}/><Route path="/app/advisor" element={<AdvisorPage/>}/><Route path="/app/menu" element={<MenuPage/>}/><Route path="/app/actions" element={<ActionsPage/>}/><Route path="/app/reviews" element={<WorkspaceModulePage/>}/><Route path="/app/marketing" element={<WorkspaceModulePage/>}/><Route path="/app/social" element={<WorkspaceModulePage/>}/><Route path="/app/reports" element={<WorkspaceModulePage/>}/><Route path="/app/billing" element={<WorkspaceModulePage/>}/><Route path="/app/integrations" element={<WorkspaceModulePage/>}/><Route path="*" element={<Navigate to="/" replace/>}/></Routes>; }
