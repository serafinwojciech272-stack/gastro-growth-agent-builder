...
type Restaurant = { id: string; name?: string | null; business_profile_id?: string | null };
...
export default function DashboardPage() {
  ...
  async function loadData(userId: string) {
    ...
    try {
      ...
      // Keep this query aligned with the canonical restaurants schema.
      // Rating/score/review aggregates are not columns on restaurants.
